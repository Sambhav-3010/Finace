...
export function IconRegulationsIndexed({ className = "h-6 w-6" }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} aria-hidden>
      ...
      <path d="M20 15h12M20 20h12M20 25h8" stroke="#7ef0cf" strokeWidth="1.5" strokeLinecap="round" opacity="0.85" />
      {/* Seal / badge */}
      <circle cx="33" cy="32" r="7" fill="#0c1412" stroke="url(#regGrad)" strokeWidth="1.5" />
      <path d="M30.5 32.2l1.6 1.6 3.4-3.6" stroke="#7ef0cf" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconClausesEmbedded({ className = "h-6 w-6" }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} aria-hidden>
      ...
      <circle cx="11" cy="16" r="3" fill="#7ef0cf" opacity="0.85" />
      <circle cx="37" cy="14" r="2.5" fill="#7ef0cf" opacity="0.7" />
      <circle cx="38" cy="32" r="3.2" fill="#7ef0cf" opacity="0.85" />
      <circle cx="12" cy="34" r="2.8" fill="#7ef0cf" opacity="0.75" />
      <path
      ...
      />
      {/* Spark marks */}
      <path d="M24 9v3M24 36v3M9 24h3M36 24h3" stroke="#7ef0cf" strokeWidth="1.4" strokeLinecap="round" opacity="0.5" />
    </svg>
  );
}
...
export function IconProofsAnchored({ className = "h-6 w-6" }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} aria-hidden>
      ...
      />
      {/* Inner lock */}
      <rect x="19" y="22" width="10" height="8" rx="2" stroke="#7ef0cf" strokeWidth="1.5" />
      <path d="M21.5 22v-2.5a2.5 2.5 0 015 0V22" stroke="#7ef0cf" strokeWidth="1.5" strokeLinecap="round" />
      <circle cx="24" cy="26" r="1.2" fill="#7ef0cf" />
      {/* Link accents */}
      <path d="M14 18c-2.5 1-4 3.2-4 6s1.5 5 4 6" stroke="#7ef0cf" strokeWidth="1.4" strokeLinecap="round" opacity="0.55" />
      <path d="M34 18c2.5 1 4 3.2 4 6s-1.5 5-4 6" stroke="#7ef0cf" strokeWidth="1.4" strokeLinecap="round" opacity="0.55" />
    </svg>
  );
}
